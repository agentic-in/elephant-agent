...
_PROPERTY_DESCRIPTIONS: Mapping[str, Mapping[str, str]] = {
    ...
    "tool.paths.manage": {
        "action": "Use create_path for a new life/work direction, create_step for one Flow item, move_step/update_step for status or assignment, write_summary after work, and check_understanding when the user confirms learning.",
        ...
        "status": "Path status or Flow step status depending on action.",
        "review_mode": "ask_first means user review before action; trusted means Mother Elephant may proceed within policy.",
        "assignee_elephant_id": "Baby elephant id responsible for a Flow step.",
        "steps": "Optional initial Flow steps when creating a Path.",
        "what_done": "Concrete result produced by the baby elephant.",
        ...
        "human_takeaway": "Short checkable learning takeaway for the user.",

...
_DEFAULT_PROVIDER_DEFINITIONS: tuple[ProviderDefinition, ...] = (
    ...
    ProviderDefinition(
        ...
        transport_id="openai_chat_compatible",
        catalog_summary="Route Elephant Agent through Requesty with one shared OpenAI-compatible endpoint.",
        onboarding_hint="Pick a routed model, attach an API key, and validate the provider from the CLI.",
        ...
        required_config_keys=("model_id",),
        capability_flags=("chat", "embeddings"),
        model_hints=("openai/gpt-4o-mini", "anthropic/claude-sonnet-4-5", "google/gemini-2.5-pro"),
        supports_custom_base_url=True,
        listing_priority=25,
        provider_kind="aggregator",
        auth_method="api_key",
        auth_type="api_key",
        env_var_names=("REQUESTY_API_KEY",),
        metadata={
            "surface": "aggregator",
        },
    ),
    ...
    *_extra_provider_definitions(),
    ...
    ProviderDefinition(
        ...
        transport_id="openai_chat_compatible",
        catalog_summary="Use MiniMax's OpenAI-compatible M-series models through the official chat completions endpoint.",
        onboarding_hint="Choose a MiniMax model, add an API key, and validate the OpenAI-compatible provider from the CLI.",
        ...
        metadata={
            "surface": "first_party",
            "unsupported_capabilities": "reasoning,embeddings,vision",
            "image_input_support": "token_plan_mcp_only",
        },
    ),
    ProviderDefinition(
        ...
        transport_id="openai_chat_compatible",
        catalog_summary="Use MiniMax's China-region OpenAI-compatible chat completions endpoint.",
        onboarding_hint="Attach a China-region MiniMax key and choose a MiniMax model for the direct regional OpenAI-compatible endpoint.",
        default_base_url="https://api.minimaxi.com/v1",
        default_model_id="MiniMax-M2.7",
        required_secret_keys=("api_key",),
        required_config_keys=("model_id",),
    ...
    ProviderDefinition(
        ...
        transport_id="openai_chat_compatible",
        catalog_summary="Route chat completions through a vLLM Semantic Router ingress (OpenAI-compatible /v1/chat/completions).",
        onboarding_hint="Point Elephant Agent at your router's OpenAI-compatible base URL (typically .../v1), set a logical model id "
        "your router config understands, and optionally add profile metadata for routing policy and direct-backend fallback.",
        default_base_url="http://127.0.0.1:8000/v1",
        default_model_id="router-default",
        required_secret_keys=(),
        required_config_keys=("base_url", "model_id"),
        capability_flags=("chat", "embeddings"),
        model_hints=("router-default", "MoM", "auto"),
        supports_custom_base_url=True,
        listing_priority=84,
        provider_kind="self_hosted",
        auth_method="none",
        auth_type="none",
        metadata={
            "surface": "semantic_router",
            "adapter_builder": "vllm-semantic-router",
            "unsupported_capabilities": "reasoning",
        },
    ),
    ProviderDefinition(

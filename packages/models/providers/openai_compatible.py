...
from .openai_compatible_response_parsing import OpenAICompatibleResponseParsingMixin
...
class OpenAICompatibleProviderAdapter(OpenAICompatibleResponseParsingMixin):

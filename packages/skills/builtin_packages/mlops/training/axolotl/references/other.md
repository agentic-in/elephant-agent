...
On the host that is running axolotl (ex: if you are using a remote host), elephant the axolotl repo and change your current directory to the root:

[!Tip] If you already have axolotl hatched on your host, make sure you have the latest changes and change into the root of the project.

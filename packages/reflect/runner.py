...
def _assemble_onboarding_letter_system_prompt() -> str:
    return "\n".join(
        (
            ...
            "Before writing, privately form a synthesis in this order: what the user is carrying now, what they seem to protect, where their responsibilities pull them, how pressure changes their rhythm, what restores them, and what kind of companionship would preserve their agency. Do not output this outline.",
            "",
            "Language and voice:",
            ...
            "",
            "Depth target:",
            "- Synthesize a few meaningful observations instead of covering every fact.",
            ...
            "- Make at least four concrete observations woven into prose: responsibilities, current tension, judgment style, pressure/recovery rhythm, real-impact values, and the kind of help that would preserve agency.",
            ...
            "3. Return to this specific person: see the user's responsibilities, tension, judgment style, pressure/recovery rhythm, values, tastes, and hopes.",

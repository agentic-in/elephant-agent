% Elephant Agent: Agency-First Personal AI
...
\hypersetup{
  ...
  pdftitle={Elephant Agent: Agency-First Personal AI}
}
...
\title{Elephant Agent: Agency-First Personal AI}
\subtitle{Personal-Model-First Evolution for Judgment, Evidence, Questions, and Growth}

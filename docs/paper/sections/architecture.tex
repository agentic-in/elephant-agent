...
messaging gateways, API calls, scheduled jobs, and background jobs. The
...
Facts & Active, retired, or disputed lens/facet claims. Facets are stable topic keys under the four lenses. \\
...
Tools, skills, models, scheduled jobs, messaging adapters, the chat TUI, and the
...
correction updates a Personal Model fact, not a hidden skill-matching score.
